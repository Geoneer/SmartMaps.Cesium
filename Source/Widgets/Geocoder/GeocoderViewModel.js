        ...
        function flyToDestination(viewModel, destination) {
            ...
            promise
                .then(function (result) {
                    ...
                    //========================================================================================================================================
                    //this is the part what is changed in the cesium source. This will save the geolocation of the result from the searchbox in the graph db.
                    //var carto = Cesium.Ellipsoid.WGS84.cartesianToCartographic(finalDestination);
                    var lon = Cesium.Math.toDegrees(result.longitude);
                    var lat = Cesium.Math.toDegrees(result.latitude);
                    SaveGeoCodingLatLon(lat, lon);
                    //========================================================================================================================================
                })
                //.always(function () {                    
                //    camera.flyTo({
